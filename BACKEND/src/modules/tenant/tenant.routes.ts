...
router.get('/platform/finance', isAuth, isSuperAdmin, ctrl.getFinance);
router.get('/platform/audit', isAuth, isSuperAdmin, ctrl.listAudit);
...
router.post('/:id/payments', isAuth, isSuperAdmin, ctrl.registerPayment);
...
router.post('/:id/cancel', isAuth, isSuperAdmin, ctrl.cancelTenant);
router.delete('/:id/purge', isAuth, isSuperAdmin, ctrl.purgeTenant);
