...
const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 antialiased overflow-x-clip">
      ...
      {/* WhatsApp flotante — canal de venta directo */}
      <a
        href="https://wa.me/573057650368?text=Hola%2C%20vi%20Merco%20y%20quiero%20m%C3%A1s%20informaci%C3%B3n%20para%20mi%20distribuidora"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Escríbenos por WhatsApp"
        className="fixed bottom-5 right-5 z-50 flex items-center gap-2 pl-3.5 pr-4 py-3 bg-[#25D366] text-white rounded-full shadow-lg shadow-black/20 hover:bg-[#1fb757] hover:scale-105 transition-all"
      >
