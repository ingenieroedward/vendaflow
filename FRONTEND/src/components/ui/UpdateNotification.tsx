  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 animate-slide-up" role="alert" aria-live="polite">
      <div className="bg-white rounded-xl shadow-2xl border border-gray-200 max-w-sm w-full mx-4 p-4 flex items-start gap-3">
        <div className="w-9 h-9 flex-shrink-0 bg-primary/10 rounded-full flex items-center justify-center">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2.5 flex gap-2">
            <button
              ...
              disabled={updating}
              className="px-3 py-1.5 bg-primary hover:bg-primary/90 disabled:opacity-50 text-white text-xs font-semibold rounded-lg transition-colors"
            >
